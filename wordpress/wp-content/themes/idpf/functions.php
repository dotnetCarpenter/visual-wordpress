...
function ari_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Læs mere <span class="meta-nav">&rarr;</span>', 'ari' ) . '</a>';
}
...
function ari_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Venstre sidebar indlæg', 'ari' ),
		'id' => 'primary-widget-area-kategori',
		'description' => __( 'Træk en widget hertil. Vises kun i kategorier og indlæg', 'ari' ),
	...
	*/
	...
	register_sidebar( array(
		'name' => __( 'Højre sidebar', 'ari' ),
		'id' => 'secondary-widget-area',
		'description' => __( 'Træk en widget hertil.', 'ari' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
                            'name' => __( 'Venstre sidebar - ikke forside', 'ari' ),
	...
	register_sidebar( array(
                            'name' => __( 'Venstre sidebar - kun forside', 'ari' ),
                            'id' => 'primary-widget-area-forside',
                            'description' => __( 'Træk en widget hertil. Vises kun på forsiden', 'ari' ),
                            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                            'after_widget' => '</li>',
                            'before_title' => '<h3 class="widget-title">',
                            'after_title' => '</h3>',
	...
	// Secondary Widget area (right, additional sidebar)
	register_sidebar( array(
		'name' => __( 'Footer A', 'ari' ),
		'id' => 'footer_a-widget-area',
		'description' => __( 'Træk en widget hertil.', 'ari' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
	...
	// Secondary Widget area (right, additional sidebar)
	register_sidebar( array(
		'name' => __( 'Footer B', 'ari' ),
		'id' => 'footer_b-widget-area',
		'description' => __( 'Træk en widget hertil.', 'ari' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="footer-widget-title">',
	...
	// Secondary Widget area (right, additional sidebar)
	register_sidebar( array(
		'name' => __( 'Footer C', 'ari' ),
		'id' => 'footer_c-widget-area',
		'description' => __( 'Træk en widget hertil.', 'ari' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="footer-widget-title">',
	...
	// Secondary Widget area (right, additional sidebar)
	register_sidebar( array(
		'name' => __( 'Footer D', 'ari' ),
		'id' => 'footer_d-widget-area',
		'description' => __( 'Træk en widget hertil.', 'ari' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="footer-widget-title">',
...
/* Ad custum widget dashboard */
    add_action('wp_dashboard_setup', 'my_custom_dashboard_widgets');
    
    function my_custom_dashboard_widgets() {
        global $wp_meta_boxes;
        
        wp_add_dashboard_widget('custom_help_widget', 'Vejledning', 'custom_dashboard_help');
    }
    
    function custom_dashboard_help() {
		
        echo '<h2>Opret din profil</h2>
<p>Vælg &quot;Profil&quot; for at udfylde din profil</p>
<p><a target="_blank" href="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/3-bruger-profil.jpg"><img src="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/3-bruger-profil.jpg" width="459" height="297" /></a></p>
<p>I &quot;Members Lists&quot; kan du vælge i hvilken &quot;liste&quot; du vil figurere.<br />
  NB: Du kan godt vælge flere lister.  <br />
  DU kan vælge imellem</p>
<ul id="undermenu">
  <li><a href="http://www.idpf.dk/psykoterapeuter/region-nordjylland/">Region Nordjylland</a></li>
  <li><a href="http://www.idpf.dk/psykoterapeuter/region-midtjylland/">Region Midtjylland</a></li>
  <li><a href="http://www.idpf.dk/psykoterapeuter/region-syddanmark/">Region Syddanmark</a></li>
  <li><a href="http://www.idpf.dk/psykoterapeuter/region-sjaelland-2/">Region Sjælland</a></li>
  <li><a href="http://www.idpf.dk/psykoterapeuter/region-hovedstaden-2/">Region Hovedstaden</a></li>
  <li><a href="http://www.idpf.dk/psykoterapeuter/kobenhavn-2/">København</a></li>
</ul>

<p>Den sidste liste, "Forsiden", kan tilvælges, hvis du vil optræde i forside-karrusellen. <br />
Det kræver du sætter et foto ind.</p>
<p>De ord, som du bruger i din profiltekst bliver også brugt af søgemaskinen inde på hjemmesiden under &quot;find
en psykoterapeut&quot;, husk derfor at nævne dine specialer</p>
  
<p><a target="_blank" href="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/3-terapeut-listerne.jpg"><img src="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/3-terapeut-listerne.jpg" width="461" height="485" /></a></p>
<p>Gå til hjemmesiden: Peg på ID Psykoterapeutisk Forening i den sorte bjælke i toppen af siden</p>
<p><a target="_blank" href="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/4-tilbage-til-admin.jpg"><img src="http://www.idpf.dk/wp-content/themes/idpf/images/vejledning/4-tilbage-til-admin.jpg" width="460" height="428" /></a></p>';
    }
